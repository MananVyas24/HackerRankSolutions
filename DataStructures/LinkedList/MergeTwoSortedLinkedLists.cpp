...
Node* MergeLists(Node *headA, Node* headB)
{
    ...
    // Recursive solution: Elegent as compared to iterative using dummy nodes
    // Uses Stack Space proportional to the leangth of the LL (-ve)
    Node *t = NULL;
    ...
    {
        t = headA;
        t->next = MergeLists(headA->next,headB);
    }
    else
    {
        t=headB;
